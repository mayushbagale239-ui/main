...
def reactor_efficiency(voltage, current, theoretical_max_power):
    ...
    if voltage*current/theoretical_max_power*100>=80:
        ...
        return "orange"
    elif voltage*current/theoretical_max_power*100>=30 and voltage*current/theoretical_max_power*100<60:
        return "red" 
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    if temperature*neutrons_produced_per_second <= 90/100 * threshold:
        return "LOW" 
    elif temperature*neutrons_produced_per_second<= 110/100 * threshold and temperature*neutrons_produced_per_second>=(-10)/100 * threshold:
        return "NORMAL"
    else:
        return "DANGER" 
